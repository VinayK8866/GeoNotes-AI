...
export const LocationPinIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M11.54 22.351l.07.04.028.016a.76.76 0 00.723 0l.028-.015.071-.041a16.975 16.975 0 005.169-4.418c1.558-2.209 2.221-4.664 2.221-7.149C20 6.065 16.418 3 12 3S4 6.065 4 10.5c0 2.485.663 4.94 2.22 7.149a16.975 16.975 0 005.17 4.418zM12 12a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" clipRule="evenodd" />
    </svg>
);

export const MapPinIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M9.69 18.933l.003.001C9.89 19.02 10 19 10 19s.11.02.308-.066l.002-.001.006-.003.018-.008a5.741 5.741 0 00.281-.14c.186-.1.4-.27.6-.533a10.9 10.9 0 002.423-3.832c.877-1.932 1.352-4.042 1.352-6.249C15 4.119 12.764 2 10 2S5 4.12 5 7.152c0 2.207.475 4.317 1.352 6.249a10.9 10.9 0 002.423 3.832c.2.263.414.433.6.533.091.048.187.1.28.14l.018.008.006.003zM10 9a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
    </svg>
);
...
export const UndoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M7.79 18.25a.75.75 0 01-.444-1.412L9.223 16H6.75a4.25 4.25 0 01-4.25-4.25V7.75a.75.75 0 011.5 0v4c0 1.517 1.233 2.75 2.75 2.75h2.473l-1.876-.833a.75.75 0 01.99-1.124l3.25 1.5a.75.75 0 010 1.124l-3.25 1.5a.75.75 0 01-.546-.144z" clipRule="evenodd" />
        <path d="M14.25 2A4.25 4.25 0 0010 6.25v3.5a.75.75 0 001.5 0v-3.5C11.5 5.517 12.733 4.5 14.25 4.5h2.003l-1.876.833a.75.75 0 10.99 1.124l3.25-1.5a.75.75 0 000-1.124l-3.25-1.5A.75.75 0 0016.253 3H14.25z" />
    </svg>
);
...
export const CogIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M8.34 1.804A1 1 0 019.32 1h1.36a1 1 0 01.98.804l.295 1.473c.497.144.971.342 1.416.587l1.25-.834a1 1 0 011.262.125l.962.962a1 1 0 01.125 1.262l-.834 1.25c.245.445.443.919.587 1.416l1.473.294a1 1 0 01.804.98v1.361a1 1 0 01-.804.98l-1.473.295a6.95 6.95 0 01-.587 1.416l.834 1.25a1 1 0 01-.125 1.262l-.962.962a1 1 0 01-1.262.125l-1.25-.834a6.953 6.953 0 01-1.416.587l-1.25-.295a6.957 6.957 0 01-1.416-.587l-1.25.834a1 1 0 01-1.262-.125l-.962-.962a1 1 0 01-.125-1.262l.834-1.25a6.957 6.957 0 01-.587-1.416l-1.473-.294A1 1 0 011 10.68V9.32a1 1 0 01.804-.98l1.473-.295c.144-.497.342-.971.587-1.416l-.834-1.25a1 1 0 01.125-1.262l.962-.962A1 1 0 015.38 3.03l1.25.834a6.957 6.957 0 011.416-.587l.294-1.473zM13 10a3 3 0 11-6 0 3 3 0 016 0z" clipRule="evenodd" />
    </svg>
);

export const SparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path d="M15.98 1.804a1 1 0 00-1.96 0l-.24 1.192a1 1 0 01-.784.785l-1.192.238a1 1 0 000 1.962l1.192.238a1 1 0 01.785.785l.238 1.192a1 1 0 001.962 0l.238-1.192a1 1 0 01.785-.785l1.192-.238a1 1 0 000-1.962l-1.192-.238a1 1 0 01-.785-.785l-.238-1.192zM6.949 5.684a1 1 0 00-1.978 0l-.233 1.324a1 1 0 01-.755.755l-1.324.233a1 1 0 000 1.978l1.324.233a1 1 0 01.755.755l.233 1.324a1 1 0 001.978 0l.233-1.324a1 1 0 01.755-.755l1.324-.233a1 1 0 000-1.978l-1.324-.233a1 1 0 01-.755-.755l-.233-1.324zM7.88 14.804a1 1 0 00-1.96 0l-.233 1.324a1 1 0 01-.755.755l-1.324.233a1 1 0 000 1.978l1.324.233a1 1 0 01.755.755l.233 1.324a1 1 0 001.978 0l.233-1.324a1 1 0 01.755-.755l1.324-.233a1 1 0 000-1.978l-1.324-.233a1 1 0 01-.755-.755l-.233-1.324z" />
    </svg>
);
...
export const UsersIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path d="M7 8a3 3 0 100-6 3 3 0 000 6zM14.5 9a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM1.615 16.428a1.224 1.224 0 01-.569-1.175 6.002 6.002 0 0111.908 0c.058.467-.172.92-.57 1.174A9.953 9.953 0 017 18a9.953 9.953 0 01-5.385-1.572zM14.5 16h-.106c.07-.297.088-.611.048-.933a7.47 7.47 0 00-.272-1.686 3.5 3.5 0 013.857 2.444.75.75 0 01-.688 1.025 3.478 3.478 0 01-2.839-.85z" />
    </svg>
);

export const WifiSlashIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M2.22 2.22a.75.75 0 011.06 0L5.5 4.44A12.045 12.045 0 0110 3.5c2.614 0 5.03.863 6.967 2.312a.75.75 0 01-.934 1.176A10.528 10.528 0 0010 5a10.545 10.545 0 00-2.939.417l2.366 2.366a7.032 7.032 0 011.962-.366 7 7 0 012.472.634.75.75 0 11-.556 1.392 5.508 5.508 0 00-1.916-.526 5.531 5.531 0 00-.896.074l2.615 2.616a2.5 2.5 0 01.558-.125.75.75 0 01.4 1.437 1 1 0 00-.492.492.75.75 0 01-.633.372h-.052l2.97 2.97a.75.75 0 01-1.06 1.06l-3.28-3.28-.707.707a.75.75 0 01-1.06 0L10 14.354l-.94.94a.75.75 0 01-1.061-1.06l.707-.707L3.28 8.1 3.219 8.04 2.22 7.038a.75.75 0 010-1.06L2.22 2.22zM8.293 9.354a3.5 3.5 0 012.322-.74l-1.922 1.922a1 1 0 00-.4-.182zm-2.366-2.366a.75.75 0 011.06 0l.354.354a5.508 5.508 0 00-1.414 1.06.75.75 0 01-1.06-1.06 7 7 0 011.06- 1.354zM2.75 6a.75.75 0 010-1.5 10.5 10.5 0 011.378.09.75.75 0 11-.153 1.492A9.014 9.014 0 002.75 6z" clipRule="evenodd" />
    </svg>
);
...
export const BuildingOfficeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M4 16.5v-13h-.25a.75.75 0 010-1.5h12.5a.75.75 0 010 1.5H16v13h.25a.75.75 0 010 1.5H3.75a.75.75 0 010-1.5H4zm3-11a.75.75 0 01.75-.75h.5a.75.75 0 01.75.75v.5a.75.75 0 01-.75.75h-.5A.75.75 0 017 6v-.5zm4.75-.75a.75.75 0 00-.75.75v.5c0 .414.336.75.75.75h.5a.75.75 0 00.75-.75v-.5a.75.75 0 00-.75-.75h-.5zM7 9.75A.75.75 0 017.75 9h.5a.75.75 0 01.75.75v.5a.75.75 0 01-.75.75h-.5A.75.75 0 017 10.25v-.5zm4.75-.75a.75.75 0 00-.75.75v.5c0 .414.336.75.75.75h.5a.75.75 0 00.75-.75v-.5a.75.75 0 00-.75-.75h-.5zm-3.75 4a.75.75 0 01.75-.75h2.5a.75.75 0 01.75.75v3.75h-4V13z" clipRule="evenodd" />
    </svg>
);

export const HeartIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path d="M9.653 16.915l-.005-.003-.019-.01a20.759 20.759 0 01-1.162-.682 22.045 22.045 0 01-2.582-1.9c-2.401-2.047-4.885-4.81-4.885-7.82 0-3.03 2.44-5.5 5.5-5.5 1.066 0 2.067.304 2.914.83a6.49 6.49 0 012.914-.83c3.06 0 5.5 2.47 5.5 5.5 0 3.01-2.484 5.773-4.885 7.82a22.022 22.022 0 01-2.582 1.9 20.27 20.27 0 01-1.162.682l-.019.01-.005.003h-.002a.75.75 0 01-.68 0l-.002-.001z" />
    </svg>
);

export const ArrowRightOnRectangleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M3 4.25A2.25 2.25 0 015.25 2h5.5A2.25 2.25 0 0013 4.25v2a.75.75 0 01-1.5 0v-2a.75.75 0 00-.75-.75h-5.5a.75.75 0 00-.75.75v11.5c0 .414.336.75.75.75h5.5a.75.75 0 00.75-.75v-2a.75.75 0 011.5 0v2A2.25 2.25 0 0110.75 18h-5.5A2.25 2.25 0 003 15.75V4.25z" clipRule="evenodd" />
        <path fillRule="evenodd" d="M19 10a.75.75 0 00-.75-.75H8.704l1.048-.943a.75.75 0 10-1.004-1.114l2.5-2.25a.75.75 0 000 1.114l-2.5 2.25a.75.75 0 10-1.004-1.114l-1.048-.943h9.546A.75.75 0 0019 10z" clipRule="evenodd" />
    </svg>
);

export const BatteryIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M13 3a1 1 0 011 1v.2h2a2 2 0 012 2v11.6a2 2 0 01-2 2H8a2 2 0 01-2-2V6.2a2 2 0 012-2h2V4a1 1 0 011-1h2z" />
  </svg>
);
...
export const EyeClosedIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path d="M3.28 2.22a.75.75 0 00-1.06 1.06l14.5 14.5a.75.75 0 101.06-1.06l-1.745-1.745a10.029 10.029 0 003.3-4.38 1.651 1.651 0 000-1.185A10.004 10.004 0 0010 3a9.956 9.956 0 00-4.744 1.192L3.28 2.22zM7.752 6.69l1.092 1.092a2.5 2.5 0 013.374 3.375l1.092 1.092a4 4 0 00-5.558-5.558zM4.936 9.404a9.954 9.954 0 00-1.272 1.186 1.65 1.65 0 000 1.185A10.004 10.004 0 0010 17c1.025 0 2.013-.153 2.943-.438l-1.397-1.397a2.5 2.5 0 01-3.14-3.14L4.936 9.404z" />
  </svg>
);